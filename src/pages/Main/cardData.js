...
export const CARD_DATA = [
    {
        ...
        contents: {
            id: 1,
            text: '전 세계에 있는 주요 이솝 스토어 네 곳의 건축과 주변의 분위기를 담은 이솝의 디자인 유산에서 영감을 받아 탄생한 새로운 기프트 키트 컬렉션.',
            more: '시즈널 기프트 키트 보기',
        },
    },
    {
    ...
    },
    {
        ...
        contents: {
            id: 1,
            text: '휠, 테싯, 마라케시 인텐스, 로즈—우디에서 플로럴에 이르기까지 밤과 낮에 모두 어울리는 현대적인 작품들',
            more: '향수 보기',
        },
    },
];
...
export const CARD_DATA_SERVICE = [
    {
        ...
        contents: {
            id: 1,
            text: '타인을 위한 선물이든 자신에게 건네는 선물이든 이솝에서는 1:1 채팅 상담, 이메일, 전화 상담 등 다양한 채널을 통해 컨설팅과 지원을 받을 수 있습니다.',
            more: '이솝 서비스 살펴보기',
        },
    },
];
